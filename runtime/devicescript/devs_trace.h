...
#define DEVS_TRACE_EV_NOW 0x40

#define DEVS_TRACE_EV_INIT 0x41
typedef struct {
    uint32_t image_hash;
} devs_trace_ev_init_t;

#define DEVS_TRACE_EV_SERVICE_PACKET 0x42

#define DEVS_TRACE_EV_NON_SERVICE_PACKET 0x43

#define DEVS_TRACE_EV_BROADCAST_PACKET 0x44

#define DEVS_TRACE_EV_ROLE_CHANGED 0x45
