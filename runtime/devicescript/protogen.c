...
const devs_builtin_function_t devs_builtin_functions[22] = {
    {N(ALLOC), 0, NO_SELF, (void *)fun1_Buffer_alloc},
    {N(LENGTH), 0, PROP, (void *)prop_Buffer_length},
    {N(TOSTRING), 0, 0, (void *)meth0_Buffer_toString},
    {N(FILLAT), 0, 0, (void *)meth3_Buffer_fillAt},
    {N(BLITAT), 0, 0, (void *)meth4_Buffer_blitAt},
    {N(SLEEPMS), 0, NO_SELF, (void *)fun1_DeviceScript_sleepMs},
    {N(PANIC), 0, NO_SELF, (void *)fun1_DeviceScript_panic},
    {N(REBOOT), 0, NO_SELF, (void *)fun0_DeviceScript_reboot},
    {N(CEIL), 0, NO_SELF, (void *)fun1_Math_ceil},
    {N(FLOOR), 0, NO_SELF, (void *)fun1_Math_floor},
    {N(ROUND), 0, NO_SELF, (void *)fun1_Math_round},
    {N(RANDOM), 0, NO_SELF, (void *)fun0_Math_random},
    {N(RANDOMINT), 0, NO_SELF, (void *)fun1_Math_randomInt},
    {N(LOG), 0, NO_SELF, (void *)fun1_Math_log},
    {N(POW), 0, NO_SELF, (void *)fun2_Math_pow},
    {N(IDIV), 0, NO_SELF, (void *)fun2_Math_idiv},
    {N(IMOD), 0, NO_SELF, (void *)fun2_Math_imod},
    {N(IMUL), 0, NO_SELF, (void *)fun2_Math_imul},
    {N(MIN), 0, NO_SELF, (void *)fun2_Math_min},
    {N(MAX), 0, NO_SELF, (void *)fun2_Math_max},
    {N(LENGTH), 0, PROP, (void *)prop_String_length},
    {N(CHARCODEAT), 0, 0, (void *)meth1_String_charCodeAt}};
