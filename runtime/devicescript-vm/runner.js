        ...
        .then(() => {
            ...
            fetch("built/bytecode.devs")
                .then(r => {
                    if (r.status == 200)
                        r.arrayBuffer()
                            .then(v => m.devsDeploy(new Uint8Array(v)))
                    else
                        console.log("you can copy or symlink built/bytecode.devs to devicescript-vm/built/bytecode.devs to pre-load it here")
                })
        }, err => {
