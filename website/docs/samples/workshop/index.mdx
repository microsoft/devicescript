...
-   Install [Node.JS 16+](https://nodejs.org/en/download/) and [Visual Studio Code](https://code.visualstudio.com/)
...
-   Follow the [Blinky](https://microsoft.github.io/devicescript/samples/blinky) to get used to the DeviceScript interface
-   Follow the [Thermostat](https://microsoft.github.io/devicescript/samples/thermostat) to get used to handle sensor data
