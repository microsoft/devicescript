---
sidebar_position: 2
description: Learn how to interact with sensors and actuators in DeviceScript
  using Jacdac services and roles.
keywords: DeviceScript, Jacdac, sensors, actuators, roles
---
