---
sidebar_position: 3
description: Learn how to read air pressure sensor data using Jacdac's
  `AirPressure` client. Subscribe to changes or read the data directly.
keywords: Jacdac, Air Pressure, Sensor, Reading, Subscribe
---
...
```ts edit
const sensor = new ds.AirPressure()
const unsubscribe = sensor.reading
