...
The `@devicescript/observables` [builtin](/developer/builtin-packages) package provides a lightweight reactive observable framework, a limited subset of [RxJS](https://rxjs.dev).
