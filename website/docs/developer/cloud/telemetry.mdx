...
description: Learn how to collect usage telemetry of your DeviceScript using
  trackEvent or trackMetric and upload it to Application Insights for analysis
  through the Azure portal.
keywords: Application Telemetry, DeviceScript, trackEvent, trackMetric, trackException
---
