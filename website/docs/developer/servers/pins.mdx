...
const pin = gpio(0)
await setMode(pin, GPIOMode.Output)
```
...
import { GPIOMode } from "@devicescript/core"
// highlight-next-line
import { digitalRead } from "@devicescript/gpio"

const pin = gpio(0)
await setMode(pin, GPIOMode.Input)
...
import { GPIOMode } from "@devicescript/core"
// highlight-next-line
import { subscribeDigital } from "@devicescript/gpio"
