...
including **GPIO**, **analog** and **I2C**. See [supported list](/devices/periphericals).

For example, the [Button](/api/servers/button) constructor allows to mount a [button server](https://microsoft.github.io/jacdac-docs/services/button)
over a pin.
