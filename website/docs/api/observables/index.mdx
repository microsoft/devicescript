...
The `@devicescript/observables` [builtin](/developer/builtin-packages) module provides a lightweight reactive observable framework, a limited subset of [RxJS](https://rxjs.dev).
