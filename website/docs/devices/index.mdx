...
* [Adafruit QT Py C3](/devices/esp32/adafruit-qt-py-c3) and [FeatherS2](/devices/esp32/feather-s2) have 
  ...
  connectors that make it easy to connect [I2C](/devices/periphericals/i2c) sensors;
  there's also [Adafruit Feather ESP32-S2](/devices/esp32/adafruit-feather-esp32-s2) in the same
  category but it's untested
* [RPi Pico W](/devices/rp2040/pico-w) is also an option if you can do little soldering or have a breakout

:::tip

Please contact us for support of other MCU archictures.
...
## [Periphericals](/devices/periphericals/)
