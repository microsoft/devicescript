...
select "MSR JM Brain S2-mini 207 v4.2".

```ts
import { pins, board } from "@dsboard/msr207_v42"
```

{@import optional ./msr207-v42-examples.mdp}
...
- [Firmware](https://github.com/microsoft/devicescript-esp32/releases/latest/download/devicescript-esp32s2-msr207_v42-0x1000.bin)
