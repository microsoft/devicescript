...
select "MSR JM Brain S2-mini 207 v4.3".

```ts
import { pins, board } from "@dsboard/msr207_v43"
```

{@import optional ./msr207-v43-examples.mdp}
...
- [Firmware](https://github.com/microsoft/devicescript-esp32/releases/latest/download/devicescript-esp32s2-msr207_v43-0x1000.bin)
