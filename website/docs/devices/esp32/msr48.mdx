...
select "MSR JacdacIoT 48 v0.2".

```ts
import { pins, board } from "@dsboard/msr48"
```

{@import optional ./msr48-examples.mdp}
...
- [Firmware](https://github.com/microsoft/devicescript-esp32/releases/latest/download/devicescript-esp32s2-msr48-0x1000.bin)
