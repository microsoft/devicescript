---
description: Espressif ESP32-S3 (bare)
---
...
select "Espressif ESP32-S3 (bare)".

```ts
import { pins, board } from "@dsboard/esp32s3_bare"
```

{@import optional ./esp32s3-bare-examples.mdp}
...
- [Firmware](https://github.com/microsoft/devicescript-esp32/releases/latest/download/devicescript-esp32s3-esp32s3_bare-0x0.bin)

## Configuration

```json title="esp32s3_bare.json"
{
