...
-   `dashboard`, starts the peripherical simulator dashboard
...
You can _watc_ any register or event in the device explorer. This provides a way to 'pin' a register for debugging
or monitoring.
