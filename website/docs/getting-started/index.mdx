...
description: Learn how to get started with DeviceScript using Visual Studio Code
  or the command line. Explore samples to help you get started quickly.
keywords: DeviceScript, TypeScript, development, Visual Studio Code, command line
---
# Getting Started
...
Once you are ready with your setup, you can start with the [samples](/getting-started/samples).
