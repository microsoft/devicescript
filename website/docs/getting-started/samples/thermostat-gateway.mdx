---
sidebar_position: 5
description: Learn how to connect a thermostat controller to a cloud gateway and
  configure the desired temperature from the cloud. Use telemetry to get
  insights into how the device is behaving. Use environment variables configured
  in the cloud rather than constants in the code. Track environment variable
  changes and update the relay accordingly.
keywords: thermostat, gateway, cloud, telemetry, environment variables
---
# Thermostat + Gateaway
