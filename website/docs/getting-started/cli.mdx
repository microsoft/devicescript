...
/sim/              Node.JS simulation project folder.
/sim/app.ts        Default simulator entry point
/sim/runtime.ts    Scafolding to mount a Jacdac bus connected to the devtools server
/sim/tsconfig.json Node.JS TypeScript configuration file
...
```
