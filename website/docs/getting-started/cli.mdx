---
sidebar_position: 2
description: Learn how to use the DeviceScript command line tool to create and
  build projects. The command line tool is compatible with container and virtual
  machines so you can run it in Docker, GitHub Codespaces, and more. Follow the
  step-by-step guide to set up your project and launch the build watch. Edit,
  deploy, and debug your code with ease using the developer tools page.
keywords: DeviceScript, command line, tool, container, virtual machines
---
# Command Line
